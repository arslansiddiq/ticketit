...
@section('content')
	...
	<p class="email-template__message" style="line-height: 1.4em;font-size: 15px;">New ticket has been created in Lead Generated support system.</p>
	<table class="email-template__schedule" style="margin: 50px auto;width: 100%;">
	  <tbody>
	    ...
	    <tr>
	      <td style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">User:</span></td>
	      <td>| {{ $notification_owner->name }} |</td>
	    </tr>
	    <tr>
	      <td style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Status:</span></td>
	      <td>| {{ $ticket->status->name }} |</td>
	    </tr>
	    <tr>
	      <td style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Category:</span></td>
	      <td>| {!! ($ticket->category->parent_category) ? $ticket->category->parent_category->name : $ticket->category->name !!} |</td>
	    </tr>
	    <tr>
	      <td style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Sub Category: </span></td>
	      <td>| {!! ($ticket->category->parent_category) ? $ticket->category->name : '-' !!} |</td>
	    </tr>
	    <tr>
